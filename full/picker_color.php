					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								...
								<li class="nav-item"><a href="form_checkboxes_radios.php" class="nav-link">REGISTAR</a></li>
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Pickers">
								...
								<li class="nav-item"><a href="picker_color.php" class="nav-link active">REGISTRAR</a></li>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="picker_color.php" class="breadcrumb-item">Pickers</a>
