					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Text editors">
								...
								<li class="nav-item"><a href="editor_ckeditor.html" class="nav-link active">REGISTRAR</a></li>
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Pickers">
								<li class="nav-item"><a href="picker_date.html" class="nav-link">LISTAR</a></li>
...
<div class="card-body">
						...
						<form action="#">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">EMPREZAS</legend>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">FRANQUISIA</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-form-label col-lg-2">IGNAGURACION</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
								</div>
